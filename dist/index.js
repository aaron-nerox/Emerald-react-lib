...
const TextButton = props => {
  ...
  return /*#__PURE__*/jsx("button", {
    disabled: props.isDisabled,
    className: `${props.EmeraldStyle} m-3 py-3 px-5 text-primary hover:bg-primary-surface
...
const ImageCheckBox = props => {
  ...
  return /*#__PURE__*/jsxs("div", {
    ...
    children: [/*#__PURE__*/jsx("img", {
      ...
      className: `h-full w-full bg-emerald-primary/60 rounded-xl absolute ${checkOverlay} transition-all`,
...
const ActionInput = props => {
  ...
  return /*#__PURE__*/jsxs("div", {
    ...
    children: [/*#__PURE__*/jsx("input", {
      ...
      placeholder: props.placeholder,
      onChange: event => props.onValueChange(event),
      className: "h-full w-full outline-none disabled:bg-disabled \r disabled:placeholder:text-disabled-dark rounded-lg"
    }), /*#__PURE__*/jsx("button", {
      disabled: props.disabled,
      className: "min-w-[40px] aspect-square py-2 bg-primary-accent \r hover:bg-primary disabled:bg-disabled rounded-lg transition-all",
      children: /*#__PURE__*/jsx("img", {
...
const SideNav = props => {
  ...
  return /*#__PURE__*/jsxs("div", {
    className: "w-[22%] h-screen max-h-screen overflow-y-auto p-2 bg-primary-accent/50\r fixed left-0 top-0 inline-flex flex-col items-start",
    children: [/*#__PURE__*/jsx("div", {
      className: "w-full min-h-[150px] bg-primary-screen rounded-lg mx-auto \r mb-5 p-3 grid content-center justify-items-center",
...
const TopNav = props => {
  ...
  let navItems = props.navItems;
  return /*#__PURE__*/jsxs("div", {
    className: "w-full h-[64px] px-3 rounded-b-lg bg-primary-screen fixed \r top-0 left-0 right-0 z-10 inline-flex flex-row items-center",
    children: [/*#__PURE__*/jsx("img", {
      src: mainLogo,
      alt: "main logo",
      className: "h-11",
      ...
      children: navItems.map((item, index) => {
        return /*#__PURE__*/jsx("li", {
          onClick: () => props.onItemClick(index),
          children: /*#__PURE__*/jsxs("div", {
            className: "w-auto inline-flex flex-row items-center m-2\r hover:bg-primary/30 rounded-lg transition-all",
            children: [/*#__PURE__*/jsx("img", {
              src: item.icon,
              alt: "nav icon",
              className: "h-7 m-2"
...
const RadioButton = props => {
  ...
  return /*#__PURE__*/jsxs("div", {
    className: `inline-flex flex-row items-center ${props.EmeraldStyle}`,
    onClick: handleItemSelection,
    children: [/*#__PURE__*/jsx("div", {
      className: `w-[25px] h-[25px] m-2 p-[2px]
                rounded-full outline outline-3 ${outlineColor}`,
      children: /*#__PURE__*/jsx("div", {
        className: `w-full h-full rounded-full ${backgroundColor}`
      })
    }), /*#__PURE__*/jsx("p", {
      className: "ml-1",
